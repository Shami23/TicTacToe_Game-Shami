...
/**
 *
 * @author Shambhu (Shami)
 */
public class GamePanel_Shami implements ActionListener
{
    JFrame jf;
    ...
    GamePanel_Shami(String player1, String player2, int total_series)
    {
